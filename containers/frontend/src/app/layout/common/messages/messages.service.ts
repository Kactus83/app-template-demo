...
export class MessagesService {
    ...
    getAll(): Observable<Message[]> {
        return this._httpClient
            .get<Message[]>(`${environment.apiUrl}/communication/messages`)
            .pipe(
                tap((messages) => {
    ...
    create(message: Message): Observable<Message> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .post<Message>(`${environment.apiUrl}/communication/messages`, { message })
                    .pipe(
                        map((newMessage) => {
    ...
    update(id: string, message: Message): Observable<Message> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .patch<Message>(`${environment.apiUrl}/communication/messages/${id}`, message)
                    .pipe(
    ...
    delete(id: string): Observable<boolean> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .delete<boolean>(`${environment.apiUrl}/communication/messages/${id}`)
                    .pipe(
    ...
    markAllAsRead(): Observable<boolean> {
        return this._messages.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .get<boolean>(
                        `${environment.apiUrl}/communication/messages/mark-all-as-read`
                    )
                    .pipe(
